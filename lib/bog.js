...
export async function createBogOrder({ totalAmount, eventCode, guests, unitPrice, internalOrderId }) {
  ...
  const resp = await fetch(CREATE_ORDER_URL, {
    ...
    headers: {
      ...
      "Accept-Language": process.env.BOG_LANGUAGE || "ru",
