...
export async function readRows(sheetName, range = "A:Z", options = {}) {
...
// Read-only dump of the whole payments sheet. Used by scripts/audit-orders.js;
// the API handlers stick to the targeted find* helpers.
